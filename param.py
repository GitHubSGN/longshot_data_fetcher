# tokens_list = ["ZRX","ZK","ZIL","ZETA","YFI","XTZ","XRP","XLM","XAI","W","WOO","WLD","WAVES","USDC","UNI","TWT",
#                "TRX","TON","TNSR","TIA","THETA","SUSHI","SUI","STX","STRK","STG","SSV","SOL","SNX","SHIB","SEI",
#                "SAND","RVN","RUNE","ROSE","RNDR","RDNT","QNT","PYTH","PORTAL","PERP","PEOPLE","PENDLE","ORDI",
#                "OP","ONE","ONDO","NEAR","MNT","MKR","MINA","MERL","MEME","MATIC","MASK","MANTA","MANA","MAGIC",
#                "LTC","LRC","LINK","LDO","KSM","KLAY","KDA","KAVA","JUP","JTO","INJ","IMX","ID","ICP","HOOK","HFT",
#                "HBAR","GRT","GMX","GMT","GAL","GALA","FXS","FTM","FLR","FLOW","FIL","FET","ETHW","ETH","ETHFI","ETC",
